...
# Cetaceo is a subclass of Mamifero and AnimalMarino. It has the same attributes as Mamifero and
# AnimalMarino, plus the attributes notas, viveEn, and peso. It has the same methods as Mamifero and
# AnimalMarino, plus the methods __nacer__ and __nadar__
